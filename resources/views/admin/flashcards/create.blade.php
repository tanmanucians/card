...
@section('content')
    ...
    <form method="post" action="{{ route('admin.flashcard.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select name="type_id" class="form-control">
                    <option name="type_id" value="1">Multiple Answer options</option>
                    <option name="type_id" value="2">Single Input</option>
                </select>
            </div>
        </div>
        <div class="form-group row" id="type1">
            ...
            <div class="col-sm-10">
                <input type="radio" name="right_answer_option_id" value="1">
                    <input type="text" class="form-control" name="value" placeholder="Input Text"><br>
                <input type="radio" name="right_answer_option_id" value="2">
                    <input type="text" class="form-control" name="value1" placeholder="Input Text"><br>
                <input type="radio" name="right_answer_option_id" value="3">
                    <input type="text" class="form-control" name="value2" placeholder="Input Text"><br>
            </div>
        </div>
